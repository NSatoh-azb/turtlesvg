...
def koch_test(t):
    ...
    t.update()
    t.save_as_svg('two_turtles_koch_sample.svg', unit_length=1, unit_width=2)
...
def dot_test(t):
    ...
    t.update()    
    t.save_as_svg('two_turtles_dot_sample.svg')
...
if __name__ == '__main__':
    ...
    t2 = ttl.Turtle()
    dot_test(t2)
    t1.save_whole_as_svg('two_turtles_whole_sample.svg')